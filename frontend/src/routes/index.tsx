                          ...
                          <div class="hm-intro__image">
                            <picture>
                              <img
                                ...
                                class="w-100 bd-radius-tr-bl-04 e-rte-image e-imginline web-img-banner"
                                src={getImageUrl(x.picture?.data?.attributes)}
                              />
                              <img
                                alt={x.mobilePicture?.data?.attributes?.name}
                                class="w-100 bd-radius-tr-bl-04 e-rte-image e-imginline mobile-img-banner"
                                src={getImageUrl(
                                  x.mobilePicture?.data?.attributes ||
                                    x.picture?.data?.attributes
                                )}
                              />
                            </picture>
                          </div>
