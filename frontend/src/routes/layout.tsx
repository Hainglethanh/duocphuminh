...
import { BlogTypeContext, getImageUrl, GlobalContext, MobileContext, ProductTypeContext } from "~/utils/conts";
        ...
        <>
          ...
          <div class="float-contact-container">
            <ol reversed>
              ...
              <li>
                <a href={""} style={{ backgroundColor: "#f6422d" }} class="float">
                  <img class="white-filter" alt="" src="/public/images/icons8-shopee.svg" />
                </a>
              </li>
            </ol>
          </div>
